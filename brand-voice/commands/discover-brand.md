...
Discover brand materials across the user's connected enterprise platforms. Search Notion, Confluence, Box, Figma, and Gong for brand guidelines, style guides, messaging frameworks, templates, and conversation transcripts.
...
If no platforms are connected, inform the user which MCP servers the plugin supports (Notion, Atlassian Confluence, Box, Figma, Gong) and how to connect them.
